...
class ImprovedLearner():
	...
	def hd_node(self):
		...
		if(((self.values[0] * self.height) + (self.values[1] * self.dist) + self.values[2]) > 0):
			...
			return 0#
		'''
		return expit(((self.values[0] * self.height) + (self.values[1] * self.dist) + self.values[2]) * 8)
	@property
	def hd2_node(self):
		'''
		if(((self.values[3] * self.height) + (self.values[4] * self.dist) + self.values[5]) > 0):
			...
			return 0#
		'''
		return expit(((self.values[3] * self.height) + (self.values[4] * self.dist) + self.values[5]) * 8)
	...
	def hidden_node1(self):
		...
		if(((self.values[6] * self.hd_node) + (self.values[7] * self.hd2_node) + self.values[8]) > 0):
			...
			return 0#
		'''
		return expit(((self.values[6] * self.hd_node) + (self.values[7] * self.hd2_node) + self.values[8]) * 8)
	...
	def hidden_node2(self):
		...
		if(((self.values[9] * self.hd_node) + (self.values[10] * self.hd2_node) + self.values[11]) > 0):
			...
			return 0#
		'''
		return expit(((self.values[9] * self.hd_node) + (self.values[10] * self.hd2_node) + self.values[11]) * 8)
	...
	def hidden1_node1(self):
		...
		if(((self.values[12] * self.hidden_node1) + (self.values[13] * self.hidden_node2) + self.values[14]) > 0):
			...
			return 0#
		'''
		return expit(((self.values[12] * self.hidden_node1) + (self.values[13] * self.hidden_node2) + self.values[14]) * 8)
	...
	def hidden1_node2(self):
		...
		if(((self.values[15] * self.hidden_node1) + (self.values[16] * self.hidden_node2) + self.values[17]) > 0):
			...
			return 0#
		'''
		return expit(((self.values[15] * self.hidden_node1) + (self.values[16] * self.hidden_node2) + self.values[17]) * 8)
	...
	def output_no_land(self):
		...
		if(((self.values[18] * self.no_land) + self.values[19]) > 0):
			...
			return 0#
		'''
		return expit((self.values[18] * self.no_land + self.values[19]) * 8)
	...
	def output_node1(self):
		...
		if(((self.values[20] * self.hidden1_node1) + (self.values[21] * self.hidden1_node2) + self.values[22]) > 0):
			...
			return 0#
		'''
		return expit(((self.values[20] * self.hidden1_node1) + (self.values[21] * self.hidden1_node2) + self.values[22]) * 8)
	...
	def output_node2(self):
		...
		if((((self.values[23] * self.hidden1_node1) + (self.values[24] * self.hidden1_node2) + self.values[25])) > 0):
			...
			return 0#
		'''
		return expit(((self.values[23] * self.hidden1_node1) + (self.values[24] * self.hidden1_node2) + self.values[25])*8)
	@property
